...
import { ArrowRight, ArrowLeft, MapPin, School, CheckCircle, Navigation, User, Bell, Home, LogOut, Map } from 'lucide-react';
...
export const ActiveTrip = ({ trip, students, schools, driver, onUpdateStudentStatus, onUpdateMultipleStudentsStatus, onFinishTrip, onBack, onLogout }: ActiveTripProps) => {
  ...
  // Status que indicam que um estudante foi REALMENTE desembarcado (apenas desembarque efetivo)
  const completedStatuses = ['disembarked'];
