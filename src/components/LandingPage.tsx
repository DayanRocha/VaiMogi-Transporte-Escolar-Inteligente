      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Revolucione o transporte escolar! Conecte motoristas, responsáveis e escolas 
            em uma plataforma inovadora que garante <span className="font-semibold text-primary">segurança total</span> 
            e <span className="font-semibold text-primary">tranquilidade</span> para toda a família.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative bg-gradient-to-br from-white via-orange-50 to-orange-100 rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-all duration-500 border border-orange-200/50 hover:border-primary/30 overflow-hidden">
                {/* Efeito de brilho no hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out"></div>
                
                <div className="relative flex flex-col items-center text-center">
                  <div className="mb-6 p-4 bg-gradient-to-br from-primary/10 to-orange-200/30 rounded-2xl group-hover:from-primary/20 group-hover:to-orange-300/40 transition-all duration-300 group-hover:rotate-3 group-hover:scale-110">
                  ...
                  <div className="mt-4 w-12 h-1 bg-gradient-to-r from-primary to-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
            ))}
          </div>
