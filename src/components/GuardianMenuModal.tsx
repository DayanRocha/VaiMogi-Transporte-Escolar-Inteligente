      ...
      <DialogContent className="sm:max-w-lg max-h-[85vh] flex flex-col p-0">
        ...
        <Tabs defaultValue="guardian" className="flex-1 flex flex-col overflow-hidden">
          <TabsList className="grid w-full grid-cols-3 mx-4 flex-shrink-0 h-12">
            <TabsTrigger value="guardian" className="flex items-center justify-center gap-1 px-1 py-2 text-xs font-medium">
              <User className="w-4 h-4 flex-shrink-0" />
              <span className="truncate">Perfil</span>
            </TabsTrigger>
            <TabsTrigger value="children" className="flex items-center justify-center gap-1 px-1 py-2 text-xs font-medium">
              <Baby className="w-4 h-4 flex-shrink-0" />
              <span className="truncate">Filhos</span>
            </TabsTrigger>
            <TabsTrigger value="driver" className="flex items-center justify-center gap-1 px-1 py-2 text-xs font-medium">
