...
export const EmptyStateModern: React.FC<EmptyStateModernProps> = ({
  type = 'custom',
  title,
  description,
  actionLabel,
...
export const EmptyStudents: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="students" {...props} />
);

export const EmptyRoutes: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="routes" {...props} />
);

export const EmptySchools: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="schools" {...props} />
);

export const EmptyGuardians: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="guardians" {...props} />
);

export const EmptyTrips: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="trips" {...props} />
);

export const EmptySearch: React.FC<Omit<EmptyStateModernProps, 'type'>> = (props) => (
  <EmptyStateModern type="search" {...props} />
);

export default EmptyStateModern;