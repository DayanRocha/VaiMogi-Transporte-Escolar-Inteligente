    ...
    <div className="p-4 space-y-4">
      ...
      <Card>
        <CardContent className="pt-6">
          {/* Verificar se todos os estudantes foram desembarcados */}
          {activeRoute && activeRoute.studentPickups.every(student => student.status === 'dropped_off') ? (
            <>
              <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-700 text-center">
                  ✅ Todos os estudantes foram desembarcados. Você pode finalizar a rota agora.
                </p>
              </div>
              <Button 
            ...
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-700 text-center">
                📍 Continue a rota. O botão de finalizar aparecerá quando todos os estudantes forem desembarcados.
              </p>
            </div>
          )}
